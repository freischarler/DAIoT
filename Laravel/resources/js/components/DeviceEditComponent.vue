    ...
    <div class="row justify-content-center">
      <form @submit.prevent="onSubmit($event)">
        <div class="form-group">
            <label for="dispositivo_serial">Serial</label>
            <input id="dispositivo_serial" v-model="dispositivo.serial" />
        </div>
        <div class="form-group">
            <label for="dispositivo_description">Descripcion</label>
            <input id="dispositivo_description" v-model="dispositivo.description" />
        </div>
        <div class="form-group">
...
export default {
  ...
  methods: {
    onSubmit(event) {
        ...
        axios.put('/api/dispositivo/'+this.$route.params.id, {
